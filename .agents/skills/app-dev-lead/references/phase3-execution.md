...
将对应规则传入 Codex project-scoped agents，并替换 `[N]` 为实际 Issue 编号：

- 新功能：使用 `feature_worker`
- 修复/改进：使用 `fix_worker`

以上 agents 的 developer_instructions 必须等价于原 worker prompt 的完整内容。
