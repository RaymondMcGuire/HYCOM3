...
const demoCase: DemoCase = {
  ...
  expectedResult: '第1断面:公式不合适;第2断面:公式不合适;第3断面:公式不合适;第4断面:公式不合适;'
}
    ...
    const definition: CalculationDefinition<Record<string, any>, IndexedSectionResult> = {
      ...
      execute: ({ input }) => {
        ...
        return buildIndexedSectionResult(
          Chapter4.cgc_sdsqss(Number(input['\\delta']), biList, hiList, viList)
        )
      },
