...
@Component({
  name: 'DynamicCkmcRangeParams',
  components: {

  }
})

export default class DynamicCKMCRangeParams extends Vue {
  ...
  public addFieldWithData(val:number, b:number, h:number, d:number, shape:number) {
    this.params.push({ value: val, B: b, H: h, d: d, shape: shape })
  }
