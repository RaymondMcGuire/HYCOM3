      ...
      <el-col :span="10">
        <el-form-item>
          <el-input
            ...
            type="text"
            :placeholder="`${explainText}${index+1}:进入渐扩段前管道面积`"
        ...
        <el-form-item>
          <el-input
            ...
            type="text"
            :placeholder="`${explainText}${index+1}:进入渐扩段后管道面积`"
            @change="onParamsDataChange"
          />
        </el-form-item>
        ...
        <el-form-item>
          <el-input
            v-model="input.alpha"
            type="text"
            :placeholder="`${explainText}${index+1}:夹角`"
            @change="onParamsDataChange"
          />
        </el-form-item>
...
// 圆形渐扩段
@Component({
  name: 'DynamicYxjkdParams',
  components: {

  }
})

export default class DynamicYXJKDParams extends Vue {
