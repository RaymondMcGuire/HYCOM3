      ...
      <div class="dynamic-field-grid__inputs">
        ...
        <el-form-item>
          <el-input
            ...
            type="text"
            :placeholder="`${explainText}${index+1}:进入突缩前管道面积`"
            @change="onParamsDataChange"
          />
        </el-form-item>
        ...
        <el-form-item>
          <el-input
            ...
            type="text"
            :placeholder="`${explainText}${index+1}:进入突缩后管道面积`"
            @change="onParamsDataChange"
          />
        </el-form-item>
...
export default createDynamicParamsComponent({
  name: 'DynamicDmtsParams',
  createEmptyItem: () => ({ omega1: '', omega2: '', B: '', H: '', d: '', shape: '' }),
  addFieldKeys: ['omega1', 'omega2', 'B', 'H', 'd', 'shape'],
  extraData: {
