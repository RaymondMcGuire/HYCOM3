 ...
 * @Date: 2023-02-06 02:01:59
 * @LastEditors: Xu.WANG raymondmgwx@gmail.com
 * @LastEditTime: 2023-02-06 02:19:08
 * @FilePath: \hycom3.0\src\views\section4\4.2\components\DynamicJKDParams.vue
 * @Description:
      ...
      <el-col :span="10">
        ...
        <el-form-item>
          <el-input
            v-model="input.l"
            type="text"
            :placeholder="`${explainText}${index+1}:进水口长度`"
            @change="onParamsDataChange"
          />
        </el-form-item>
...
@Component({
  name: 'DynamicJkdParams',
  components: {

  }
})

export default class DynamicJKDParams extends Vue {
